/**
 */
package cn.edu.tsinghua.classdiagram.classdiagram.util;
 ...
 * <!-- end-user-doc -->
 * @see cn.edu.tsinghua.classdiagram.classdiagram.ModelPackage
 * @generated
 */
public class ModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ModelPackage.CLASS: {
				cn.edu.tsinghua.classdiagram.classdiagram.Class class_ = (cn.edu.tsinghua.classdiagram.classdiagram.Class)theEObject;
	 ...
	 * @generated
	 */
	public T caseClass(cn.edu.tsinghua.classdiagram.classdiagram.Class object) {
		return null;
	}
